...
$leaveRecords = getAllLeaveRequestsFiltered($search, $status);

$totalRecords = count($leaveRecords);
$totalPages = max(1, ceil($totalRecords / $perPage));
$page = max(1, min($page, $totalPages));

$offset = ($page - 1) * $perPage;
$paginatedRecords = array_slice($leaveRecords, $offset, $perPage);
...
<?php else: ?>
  ...
  <tr>
    ...
    <td data-cell="Attachment">
      <?php echo $record['attachment_path'] ? 'Yes' : 'N/A'; ?>
    </td>
    <td data-cell="Status">
      <?php
