          ...
          <td data-cell="Action">
            <div class="table-btn">
              ...
              <button class="tableBtn outlineBtn"
                      ...
                      data-url="ajax/prompt.php?id=105&msg=Are you sure you want to delete Employee? &action=employee">
                <i class="fa-regular fa-trash-can"></i>
              </button>
              <button class="tableBtn outlineBtn"
                      data-trigger="modal"
                      data-title="Confirm Action"
                      data-url="ajax/prompt.php?id=105&msg=Are you sure you want to Block Employee? &action=employee">
          ...
          <td data-cell="Action">
            <div class="table-btn">
              ...
              <button class="tableBtn outlineBtn"
                      data-trigger="modal"
                      data-title="Confirm Deletion"
                      data-url="ajax/prompt.php?id=105&msg=Are you sure you want to delete Item? &action=employee">
                <i class="fa-regular fa-trash-can"></i>
              </button>
              <button class="tableBtn outlineBtn"
                      data-trigger="modal"
