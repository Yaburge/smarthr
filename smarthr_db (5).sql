...
--
-- Host: localhost:3306
-- Generation Time: Dec 02, 2025 at 01:05 AM
...
CREATE TABLE `attendance` (
  ...
  `status` enum('Present','Late','Absent','Half Day') DEFAULT 'Absent',
...
--
ALTER TABLE `employee_documents`
  MODIFY `document_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
